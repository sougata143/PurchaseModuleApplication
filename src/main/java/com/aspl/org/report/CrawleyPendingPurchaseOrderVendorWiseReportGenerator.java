...
public class CrawleyPendingPurchaseOrderVendorWiseReportGenerator {
	...
	static String fileName = "crawley-pending-purchase-order-vendor-wise-report";
	...
	static String reportName 	= "Pending Purchase Order (VENDOR WISE)";
...
//		document.add(listItems);
	...
	public static PdfPTable createHeader3(String startDate, String endDate) throws DocumentException {
		...
		cell_1:{
			...
			Paragraph para_1 = new Paragraph();
			para_1.add(new Chunk("Dated From " + startDate + " To " + endDate, Font9Bold));
			para_1.add(Chunk.NEWLINE);
			para_1.setSpacingBefore(10);
			para_1.setSpacingAfter(10);
	...
	public static PdfPTable createHeader4(String vendorName) throws DocumentException {
		PdfPTable table = new PdfPTable(1);
		...
		cell_1:{
			...
			Paragraph para_1 = new Paragraph();
			para_1.add(new Chunk("Vendor Name : ", Font9Bold));
			para_1.add(new Chunk(vendorName, Font9));
			para_1.add(Chunk.NEWLINE);
			para_1.setSpacingBefore(10);
			para_1.setSpacingAfter(10);
	...
	public static PdfPTable createDescriptionTableHead1() throws DocumentException {
		...
		dataTable.setWidths(new float[]{5, 2, 1, (float) 1.5, (float) 1.5, (float) 0.5, 2});
		
		String[] headersLabels = {"Item Code","Item Name","P.O. No","P.O. Date","Pending Order Qty","Unit","Order value"};
	...
	public static PdfPTable createDescriptionTable(String itemCode, String itemName, String pono, Date poDate, Double qnt, String unit, Double value) throws DocumentException {
		PdfPTable dataTable = new PdfPTable(7);
		...
		///////////////////////////////////////////////////////////////
			...
			cell_7: {
				...
				Paragraph para_2 = new Paragraph();
				para_2.add(new Chunk(String.valueOf(value), Font7));
				cell = new PdfPCell(para_2);
				cell.setPadding(3);
				//cell.setBorder(Rectangle.NO_BORDER);
				cell.setHorizontalAlignment(Element.ALIGN_CENTER);
