...
public class CrawleyNoPurchaseOrderOfAuthorisedIndentReportGenerator {
	...
	static String fileName = "crawley-purchase-indent-pending-report";
	...
	static String reportName 	= "PURCHASE INDENT PENDING";
